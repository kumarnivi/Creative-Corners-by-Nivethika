    ...
    >
      ...
      <div className="text-center mb-10 relative z-10">
        <h1 className="text-white text-3xl sm:text-4xl font-bold uppercase relative inline-block font-[cursive]">
          <span className="block w-[75px] h-[3px] bg-[#930e66] mb-2 ml-0"></span>
          Experience
      ...
      {isMobile ? (
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap gap-5 justify-center relative z-10">
                ...
                <div className="max-h-0 opacity-0 group-hover:max-h-[200px] group-hover:opacity-100 transition-all duration-700 overflow-hidden">
                  <div className="flex justify-center w-full gap-2">
                    {news.excerpt.map((item, index) => (
                      <p
                        key={index}
                        className="text-sm bg-white rounded p-2 px-[20px] text-black"
                      >
                        - {item.title}
                      </p>
                    ))}
                  ...
                  <div className="flex justify-between">
                    ...
                    >
                      <img
                        src="/assets/images/external-link (1).png"
